                      ...
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1.5 mt-0.5">
                            ...
                            {lead.leadType && <span className="px-1.5 py-0.5 bg-slate-100 text-slate-500 rounded flex-shrink-0 text-[8px] font-black uppercase tracking-widest">{lead.leadType}</span>}
                          </div>
                        </div>
                      </div>
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}>
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight text-slate-900">Clients</h1>
          </motion.div>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
            ...
            <div className="relative flex-1 md:flex-none">
              <select
                ...
                className="w-full px-5 py-3 border border-slate-200 bg-white rounded-xl text-sm font-bold text-slate-600 outline-none hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm appearance-none cursor-pointer pr-10"
              >
                          ...
                          <tr className={`border-b border-slate-50 hover:bg-slate-50/80 transition-all duration-300 group ${isExp ? 'bg-indigo-50/30 shadow-inner' : ''}`}>
                            ...
                            <td className="py-5 px-8 whitespace-nowrap text-right">
                              <div className="flex items-center justify-end gap-2">
                                <Link to={`/analytics/${lead.id}`} className="text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 w-9 h-9 flex items-center justify-center rounded-xl transition-all border border-transparent hover:border-indigo-100">
                                  <BarChart3 size={14} />
                                </Link>
                                  ...
                                  <div className="p-8 px-12">
                                      ...
                                      <div className="mb-8 pb-8 border-b border-slate-100 border-dashed">
                                        ...
                                        <div className="flex flex-wrap gap-4">
                                          {customFieldDefs.map(field => (
                                            <div key={field.id} className="bg-white px-5 py-3 rounded-2xl border border-slate-100 shadow-sm flex flex-col min-w-[120px]">
                                    ...
                                    <div className="flex items-center justify-between mb-6">
                                      <h4 className="text-[10px] font-black text-indigo-600 uppercase tracking-widest flex items-center gap-2">
                                        History <span className="bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded-md border border-indigo-200">{leadRecs.length}</span>
                                      </h4>
        ...
        {showSafetyAlert && (
          ...
          >
            ...
            >
              ...
              <h2 className="text-xl font-black text-slate-900 mb-2">Still there?</h2>
              <p className="text-slate-500 text-sm mb-1 font-medium">
                Recording for <span className="text-slate-900 font-bold">{Math.floor(recordingSeconds / 60)} minutes</span>.
              </p>
