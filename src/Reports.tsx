      ...
      <div className="max-w-[1400px] mx-auto p-4 sm:p-8 lg:p-12 space-y-10">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
            ...
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-slate-900 leading-tight">Call Intelligence</h1>
        ...
        <motion.div 
          ...
          className="glass-card !bg-white/80 p-5 flex flex-col lg:flex-row items-center justify-between gap-6"
        >
          <div className="relative w-full max-w-2xl group">
            ...
            <input
              ...
              placeholder="Search by transcript content, client name, or company..."
              className="w-full pl-14 pr-6 py-4 bg-slate-50 hover:bg-white border border-slate-200 rounded-2xl text-base font-semibold focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-400 transition-all placeholder:text-slate-300 text-slate-700 shadow-inner"
            />
          </div>
          <div className="flex gap-4 w-full lg:w-auto">
            <button className="flex-1 lg:flex-none flex items-center justify-center gap-3 px-8 py-4 bg-white border border-slate-200 rounded-2xl text-sm font-black text-slate-600 hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm active:scale-95">
            ...
            {enrichedRecordings.length === 0 ? (
              ...
              enrichedRecordings.map((rec, index) => (
                ...
                >
                  ...
                  <div className="p-8 lg:p-10 lg:w-[40%] bg-slate-50/30 border-b lg:border-b-0 lg:border-r border-slate-100 flex flex-col justify-between relative">
                    <div className="space-y-8">
                      {rec.lead ? (
                        <div className="flex items-center gap-5">
                          <div className="relative">
                            <img 
                              ...
                              alt={rec.lead.name}
                              className="w-16 h-16 rounded-2xl object-cover ring-4 ring-white shadow-xl shadow-slate-200/40" 
                            />
                            <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-emerald-500 border-4 border-white shadow-sm" />
                          </div>
                          <div className="min-w-0">
                            <h3 className="font-black text-xl text-slate-900 tracking-tight truncate">{rec.lead.name}</h3>
                            <div className="text-xs font-black text-indigo-500 mt-1 uppercase tracking-widest truncate flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-5 opacity-60">
                          <div className="w-16 h-16 rounded-2xl bg-slate-200/50 flex items-center justify-center text-slate-400 font-black text-2xl shadow-inner border border-slate-200">?</div>
                          <div>
                            <h3 className="font-extrabold text-xl text-slate-700 tracking-tight">Unlinked Session</h3>
                            <div className="text-xs font-bold text-slate-400 mt-1 uppercase tracking-widest">Isolated Discovery</div>
                          </div>
                        </div>
                      )}
                  ...
                  <div className="p-8 lg:p-12 flex-1 flex flex-col relative bg-white/40">
                    <div className="absolute top-8 right-10 text-[10rem] text-indigo-500/5 font-serif leading-none italic pointer-events-none select-none">"</div>
                    ...
                    <div className="space-y-6 relative z-10">
                      ...
                      <div className="relative group/transcript">
                        ...
                        <p className="text-lg md:text-xl text-slate-600 italic leading-relaxed font-medium relative z-10 line-clamp-3">
                          "{rec.transcript}"
                        </p>
                      </div>
