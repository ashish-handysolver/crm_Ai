              ...
              enrichedRecordings.map((rec, index) => (
                ...
                >
                    ...
                    <div>
                      {rec.lead ? (
                        <div className="flex items-center gap-4 mb-6">
                          ...
                          <div>
                            <h3 className="font-extrabold text-lg text-slate-900">{rec.lead.name}</h3>
                            <div className="text-xs font-semibold text-slate-500 mt-0.5 max-w-[200px] truncate bg-slate-100 px-2 py-0.5 rounded-md inline-flex">{rec.lead.company} {rec.lead.location ? `• ${rec.lead.location}` : ''}</div>
                          </div>
                        </div>
                      ) : (
                  ...
                  <div className="p-6 md:p-8 flex-1 flex flex-col relative bg-white">
                    ...
                    <div className="text-[10px] font-bold text-indigo-400 tracking-widest uppercase mb-4 flex items-center gap-2 relative z-10">
                      <AudioWaveform size={14} /> Snippet Preview
                    </div>
                    <div className="flex-1 bg-slate-50/50 rounded-2xl p-6 border border-slate-100 relative z-10 group-hover:bg-slate-50 transition-colors">
