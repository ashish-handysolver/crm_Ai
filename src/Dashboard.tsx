              ...
              <motion.div key="overview" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.2 }} className="space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <section className="bg-orange-50 p-8 rounded-[2rem] border border-orange-100 shadow-sm">
                    ...
                    <div className="max-h-[420px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-orange-400/70 scrollbar-track-orange-50">
                      <div className="grid grid-cols-2 gap-4">
                        {pipelineData.map(item => (
                          <div key={item.name} className="bg-orange-50 p-5 rounded-2xl border border-orange-100">
                  ...
                  <section className="bg-orange-50 p-8 rounded-[2rem] border border-orange-100 shadow-sm">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      {['HOT', 'WARM', 'COLD'].map(health => (
                        <div key={health} className="bg-orange-50 p-5 rounded-2xl border border-orange-100 flex flex-col justify-center">
