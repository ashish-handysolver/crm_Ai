        ...
        <header className="mb-12">
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex items-end justify-between">
              <div>
                <h3 className="text-4xl sm:text-6xl font-black tracking-tight text-slate-900 leading-none">My Profile</h3>
              </div>
              <div className="hidden md:flex flex-col items-end gap-2 text-right">
                <div className="px-4 py-2 bg-slate-900 rounded-2xl text-[10px] font-black text-indigo-400 uppercase tracking-widest shadow-xl shadow-slate-900/10" style={{ "color": "#fffafa" }}>Admin Access</div>
