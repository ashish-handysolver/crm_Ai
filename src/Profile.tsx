      ...
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-12">
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
             <button onClick={() => navigate(-1)} className="inline-flex items-center gap-2 text-slate-400 hover:text-indigo-600 transition-all mb-4 group px-2 py-1 rounded-lg hover:bg-indigo-50/50">
                <ArrowLeft size={14} className="group-hover:-translate-x-1 transition-transform" />
                <span className="text-[10px] font-black uppercase tracking-[0.2em]">Back to Dashboard</span>
             </button>
             <div className="flex items-end justify-between">
                <div>
                   <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-slate-900 leading-none">My Profile</h1>
                   <p className="text-slate-400 mt-4 text-base font-medium max-w-md italic">Manage your personal information and login details.</p>
                </div>
                 <div className="hidden md:flex flex-col items-end gap-2 text-right">
                   <div className="px-4 py-2 bg-slate-900 rounded-2xl text-[10px] font-black text-indigo-400 uppercase tracking-widest shadow-xl shadow-slate-900/10">Admin Access</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="lg:col-span-4 space-y-6 lg:sticky lg:top-8">
            <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.04)] overflow-hidden">
               ...
               <div className="px-8 pb-8 -mt-12 text-center">
                  <div className="relative inline-block mb-6">
                    ...
                    <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-xl bg-emerald-500 border-4 border-white shadow-lg"></div>
                  </div>
                  ...
                  <div className="flex items-center justify-center gap-2 px-4 py-2 bg-slate-50 rounded-2xl border border-slate-100/50 mb-8">
                     <span className="text-[10px] font-black text-indigo-600 uppercase tracking-widest">{userRole || 'Entity'}</span>
            ...
            <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white shadow-2xl shadow-indigo-900/20 relative overflow-hidden group">
               <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-500/10 rounded-full blur-[40px] pointer-events-none translate-x-1/2 -translate-y-1/2 group-hover:bg-indigo-500/20 transition-all duration-700"></div>
               <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-2xl bg-indigo-500/20 text-indigo-400 flex items-center justify-center shadow-inner"><ShieldCheck size={20} /></div>
                  <h3 className="text-[10px] font-black text-indigo-400 tracking-[0.2em] uppercase">Security Matrix</h3>
               </div>
               <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-white/5 rounded-2xl border border-white/5">
                     ...
                     <span className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">AES-256</span>
                  </div>
               </div>
               <div className="mt-6 flex gap-2">
                  <div className="w-full h-1 bg-white/5 rounded-full overflow-hidden">
                     <div className="h-full w-3/4 bg-indigo-500 rounded-full shadow-[0_0_10px_rgba(99,102,241,0.5)]"></div>
                  </div>
               </div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="lg:col-span-8">
            <form onSubmit={handleUpdateProfile} className="bg-white rounded-[3rem] p-8 sm:p-12 border border-slate-100 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.04)] relative">
              <div className="space-y-10">
                
                <section>
                  <div className="flex items-center gap-4 mb-8">
                     <div className="w-12 h-12 rounded-2xl bg-slate-50 text-slate-900 flex items-center justify-center shadow-sm border border-slate-100">
                        <User size={22} />
                     </div>
                     <div>
                ...
                <div className="h-[1px] bg-slate-100 opacity-50"></div>
                ...
                <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-6">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full md:w-auto flex items-center justify-center gap-3 bg-slate-900 text-white px-10 py-5 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-2xl shadow-slate-900/10 active:scale-95 disabled:opacity-50"
                  >
                    {loading ? <Loader2 className="animate-spin text-indigo-400" size={18} /> : <CheckCircle2 size={18} className="text-indigo-400" />}
                    Save Changes
                  </button>
                      <button
                        type="button"
